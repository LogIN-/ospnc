 ...
 * @Last Modified time: 2014-10-18 12:17:51
 */
        ...
        request(options, function(error, response, body) {
            if (!error) {
                ...
                output = {
                    name: plugin.reqName,
                    host: plugin.reqHost,
                    status: responsResoult[plugin.checkField] || 'unknown'
                };
            ...
            // Set output to our result object
